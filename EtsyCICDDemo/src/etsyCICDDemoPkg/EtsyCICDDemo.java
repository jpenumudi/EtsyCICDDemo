...
public class EtsyCICDDemo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='join_neu_email_field']")).sendKeys("whole@gmail.com");
		
		// ENTER FIRST NAME
		
		driver.findElement(By.xpath("//input[@id='join_neu_first_name_field']")).sendKeys("Nine");
		
		// ENTER PASSWORD
		
		driver.findElement(By.xpath("//input[@id='join_neu_password_field']")).sendKeys("yards!23");
